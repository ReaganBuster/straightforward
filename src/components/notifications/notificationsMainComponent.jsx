...
import { 
  Heart, ArrowUpRight, Clock, Share2, Check, CheckCheck, 
  LineChart, Activity, User, Home, Search, Mail, Plus, TrendingUp, 
  DollarSign, Zap, Star, MessageSquare, Users, HelpCircle, 
  ChevronRight, Bell, BarChart2, Gift, Settings, ChevronDown
} from 'lucide-react';

const NotificationsMainComponent = ({ user }) => {
...
//   };
  ...
  const filteredNotifications = notifications.filter(notification => {
    ...
    if (activeTab === 'messages' && notification.notification_type === 'new_message') return true;
    if (activeTab === 'payments' && 
        ['content_unlock', 'new_subscription'].includes(notification.notification_type)) return true;
    return false;
  });
    ...
    <div className="flex min-h-screen bg-gray-50 w-full">
      ...
      >
        ...
        <nav className="space-y-1 mb-4">
          ...
          <Link to="/notifications" className="flex items-center px-3 py-2 text-red-600 bg-red-50 rounded-lg">
            <Bell className="w-4 h-4 mr-2" />
            <span className="font-medium">NotificationsMainComponent</span>
            <span className="ml-auto bg-red-600 text-white text-xs font-bold px-1.5 py-0.5 rounded-full">{notifications.filter(n => !n.is_read).length}</span>
          </Link>
        </nav>
        ...
        <div className="p-2 bg-gray-50 rounded-lg mb-4">
          ...
          <div className="space-y-2 text-xs">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-red-600">45,000 UGX</span>
            </div>
            <div className="flex justify-between">
              ...
              <div className="flex-1">
                ...
                {(notification.notification_type === 'content_unlock' || 
                  ...
                  <div className="mt-1 inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                    ...
                    {notification.content.match(/\d{1,3}(,\d{3})*(\.\d+)? UGX/)[0]}
                  </div>
                )}
              </div>
      ...
      >
        <div className="bg-white rounded-lg p-3 mb-3 border border-gray-200 shadow-sm">
          <h3 className="font-bold text-sm text-gray-900 mb-2">Notification Settings</h3>
          ...
          <div className="space-y-3 mb-3">
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-700">Mobile push notifications</div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" value="" className="sr-only peer" defaultChecked />
                <div className="w-9 h-5 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-red-600"></div>
              </label>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-700">New message notifications</div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" value="" className="sr-only peer" defaultChecked />
                <div className="w-9 h-5 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-red-600"></div>
              </label>
        ...
        <div className="bg-white rounded-lg p-3 mb-3 border border-gray-200 shadow-sm">
          <h3 className="font-bold text-sm text-gray-900 mb-2">Recent Activity</h3>
        ...
        <div className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm">
          <h3 className="font-bold text-sm text-gray-900 mb-2">Tips & Suggestions</h3>
          ...
          <div className="space-y-3">
            <div className="p-2 bg-red-50 rounded-lg text-xs">
              ...
              <p className="text-red-800">Post regularly to keep your followers engaged and increase your earnings potential.</p>
            </div>
            ...
            <div className="p-2 bg-amber-50 rounded-lg text-xs">
              ...
              <p className="text-amber-800">Unlock premium features to grow your audience and increase your earnings.</p>
            ...
            <div className="p-2 bg-blue-50 rounded-lg text-xs">
              ...
              <p className="text-blue-800">Respond promptly to messages to maintain a high response rate and build trust with your audience.</p>
            </div>
          </div>
        </div>
...
export default NotificationsMainComponent;