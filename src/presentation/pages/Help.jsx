    ...
    general: [
      {
        ...
        answer:
          'PayPadm is a social platform that allows experts to monetize their knowledge by sharing insights and responding to direct messages. Users can discover free content or pay to unlock premium content and direct messaging with experts.',
      },
      {
        id: 'how-to-get-started',
        question: 'How do I get started on PayPadm?',
        answer:
          'To get started, complete your profile with your expertise areas, set your messaging rate, and start sharing valuable content through posts. Engage with the community by responding to questions and creating both free and premium content.',
      },
      {
        id: 'difference-free-premium',
        question: "What's the difference between free and premium content?",
        answer:
          'Free content is accessible to all users. Premium content requires payment to unlock and typically contains more in-depth insights, analysis, or exclusive information. As a creator, you can choose which content to make premium to monetize your expertise.',
      },
    ],
    account: [
      {
        ...
        answer:
          'Navigate to your Profile page by clicking on the Profile option in the left sidebar. Then click on the Edit Profile button to update your information, expertise areas, profile picture, and bio.',
      },
      {
        id: 'verification',
        question: 'How can I get verified?',
        answer:
          'Verification is granted to established experts with consistent high-quality contributions. Maintain a high response rate, positive ratings, and regular content creation. You can apply for verification after reaching 100,000 UGX in earnings.',
      },
    ],
    payments: [
      {
        ...
        answer:
          'Go to your account section in the right sidebar and click on "Withdraw Funds". You can withdraw to mobile money or bank accounts. The minimum withdrawal amount is 10,000 UGX, and processing takes 1-2 business days.',
      },
      {
        id: 'platform-fees',
        question: 'What are the platform fees?',
        answer:
          'PayPadm takes a 15% fee from all transactions. This means you receive 85% of your earnings from direct messages and premium content. Fees help maintain the platform and provide customer support.',
      },
      {
        id: 'set-message-rate',
        question: 'How do I set my message rate?',
        answer:
          'You can adjust your message rate in the right sidebar under "Your Message Rate" section. Move the slider to set your desired rate per message. We recommend setting a rate between 3,000-7,000 UGX based on your expertise level.',
      },
    ],
    messaging: [
      {
        ...
        answer:
          'Users pay your set rate to send you a direct message. You receive 85% of this amount when you respond. Maintain a high response rate (above 90%) to appear in recommendations and search results. You have 24 hours to respond to paid messages.',
      },
      {
        id: 'message-notifications',
        question: 'How will I know when I receive messages?',
        answer:
          "You'll receive notifications on the platform and via email for new paid messages. You can manage notification preferences in your Settings page under the Notifications tab.",
      },
    ],
    posting: [
      {
        ...
        answer:
          'Click on the "New Post" button in the left sidebar or use the post composer at the top of your feed. You can create text posts, add images, and decide whether to make your content free or premium by toggling the lock icon.',
      },
      {
        id: 'premium-post',
        question: 'How do I set up a premium post?',
        answer:
          'When creating a post, click the lock icon to make it premium. Set a price that users will pay to unlock the content. Good premium content typically includes in-depth analysis, exclusive insights, or useful resources.',
      },
    ],
    security: [
      {
        ...
        answer:
          'Enable two-factor authentication in your Settings under the Security tab. Use a strong password and regularly update it. Be cautious about clicking links in messages and never share your login credentials.',
      },
      {
        id: 'report-problem',
        question: 'How do I report a problem or abusive user?',
        answer:
          'Click the three dots menu (...) on any post or message and select "Report". Fill in the details of your concern. Our trust and safety team reviews all reports within 24 hours.',
      },
    ],
  };
    ...
    <div className="flex min-h-screen bg-gray-50 w-full">
      ...
      >
        ...
        <nav className="space-y-1 mb-4">
          ...
          <Link
            to="/help"
            className="flex items-center px-3 py-2 text-red-600 bg-red-50 rounded-lg"
          >
        ...
        <div className="p-2 bg-gray-50 rounded-lg mb-4">
          ...
          <div className="space-y-2">
            {popularArticles.map((article, index) => (
              <div
                key={index}
                className="flex items-center text-xs text-gray-700 hover:text-red-600 cursor-pointer p-1 hover:bg-gray-100 rounded"
              >
        ...
        <div className="mt-auto space-y-1 text-xs">
          <Link
            to="/settings"
            className="flex items-center justify-between text-gray-600 p-2 hover:bg-gray-100 rounded"
          >
        ...
        <div className="p-3">
          ...
          <div className="mt-4 p-3 bg-red-50 rounded-lg border border-red-100">
            <p className="text-sm text-red-800 mb-2">
              Didn't find what you're looking for? Our support team is here to
              help.
            </p>
        ...
        <div className="bg-white rounded-lg p-3 mb-3 border border-gray-200 shadow-sm">
          ...
          <div className="space-y-3">
            ...
            <h4 className="font-medium text-sm">
              Getting Started with PayPadm
            </h4>
            <p className="text-xs text-gray-500">
              Learn the basics of PayPadm and how to set up your expert profile
            </p>
          ...
          <div className="space-y-3">
            <div className="p-2 bg-gray-50 rounded-lg">
              <p className="text-xs text-gray-700">
                ...
                Experts with complete profiles earn up to 40% more
              </p>
            </div>

            <div className="p-2 bg-gray-50 rounded-lg">
              <p className="text-xs text-gray-700">
                <span className="font-medium">Respond quickly:</span> Aim to
                respond to messages within 2-4 hours for higher ratings
              </p>
            </div>

            <div className="p-2 bg-gray-50 rounded-lg">
              <p className="text-xs text-gray-700">
                <span className="font-medium">Post regularly:</span> Share
                insights at least 3 times per week to stay visible
              </p>
            </div>

            <div className="p-2 bg-gray-50 rounded-lg">
              <p className="text-xs text-gray-700">
                <span className="font-medium">Use analytics:</span> Check your
                performance weekly to optimize your content
              </p>
            </div>
          </div>
        </div>
