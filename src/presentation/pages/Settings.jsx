    ...
    <div className="space-y-4">
      ...
      <div className="border-t border-gray-200 pt-4 mt-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            You will receive 85% of this amount after platform fees
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg">
          ...
          >
            <span
              className={`block w-4 h-4 rounded-full transition ${notificationPrefs.messages ? 'bg-white mr-0.5' : 'bg-white ml-0.5'}`}
            ></span>
          </button>
        </div>
        ...
        <div className="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg">
          ...
          >
            <span
              className={`block w-4 h-4 rounded-full transition ${notificationPrefs.transactions ? 'bg-white mr-0.5' : 'bg-white ml-0.5'}`}
            ></span>
          </button>
        </div>
        ...
        <div className="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg">
          ...
          >
            <span
              className={`block w-4 h-4 rounded-full transition ${notificationPrefs.new_followers ? 'bg-white mr-0.5' : 'bg-white ml-0.5'}`}
            ></span>
          </button>
        </div>
        ...
        <div className="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg">
          ...
          >
            <span
              className={`block w-4 h-4 rounded-full transition ${notificationPrefs.post_interactions ? 'bg-white mr-0.5' : 'bg-white ml-0.5'}`}
            ></span>
          </button>
        </div>
        ...
        <div className="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg">
          ...
          >
            <span
              className={`block w-4 h-4 rounded-full transition ${notificationPrefs.marketing ? 'bg-white mr-0.5' : 'bg-white ml-0.5'}`}
            ></span>
          </button>
        </div>
      </div>
      ...
      <div className="text-xs text-gray-500 mt-2">
        We'll always send you important notifications about your account
    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center">
            <input
              ...
              onChange={() =>
                handlePrivacyChange('profile_visibility', 'public')
              }
          ...
          <div className="flex items-center">
            <input
              ...
              onChange={() =>
                handlePrivacyChange('profile_visibility', 'limited')
              }
              className="h-4 w-4 text-red-600 focus:ring-red-500"
            />
          ...
          <div className="flex items-center">
            <input
              ...
              onChange={() =>
                handlePrivacyChange('profile_visibility', 'private')
              }
              className="h-4 w-4 text-red-600 focus:ring-red-500"
            />
      ...
      <div className="border-b border-gray-200 pb-4 mb-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          >
            <span
              className={`block w-4 h-4 rounded-full transition ${privacySettings.requires_payment_for_dm ? 'bg-white mr-0.5' : 'bg-white ml-0.5'}`}
            ></span>
          </button>
        </div>
        ...
        {privacySettings.requires_payment_for_dm && (
          <div>
            ...
            <input
              ...
              onChange={e =>
                handlePrivacyChange('dm_fee', parseInt(e.target.value, 10) || 0)
              }
              min="0"
              step="1000"
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500"
            />
            <p className="text-xs text-gray-500 mt-1">
              This is a one-time fee for users to start a conversation with you
            </p>
          </div>
        )}
      </div>
      ...
      <div>
        ...
        <div className="mt-3">
          ...
          <textarea
            ...
            onChange={e =>
              handlePrivacyChange('subscription_description', e.target.value)
            }
            rows="3"
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500"
    ...
    <div className="space-y-4">
      ...
      <div className="border-b border-gray-200 pb-4 mb-4">
        <div className="flex items-center justify-between mb-3">
          ...
          >
            <span
              className={`block w-4 h-4 rounded-full transition ${securitySettings.two_factor_enabled ? 'bg-white mr-0.5' : 'bg-white ml-0.5'}`}
            ></span>
          </button>
        </div>
      </div>
      ...
      <div className="border-b border-gray-200 pb-4 mb-4">
        <div className="flex items-center justify-between mb-3">
          ...
          >
            <span
              className={`block w-4 h-4 rounded-full transition ${securitySettings.login_notifications ? 'bg-white mr-0.5' : 'bg-white ml-0.5'}`}
            ></span>
          </button>
        </div>
      </div>
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200 p-3">
        ...
        <Link
          to="/"
          className="flex items-center px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg mb-4"
        >
        ...
        <div className="md:hidden bg-white p-3 border-b border-gray-200 sticky top-0 z-10">
          <div className="flex items-center justify-between">
            ...
            <div className="w-8 h-8 bg-gray-300 rounded-full overflow-hidden">
              <img
                src={profile?.avatar_url || '/api/placeholder/32/32'}
                alt="Profile"
                className="w-full h-full object-cover"
              />
            </div>
