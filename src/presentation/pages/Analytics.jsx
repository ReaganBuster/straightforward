...
import { useUserStats } from '@presentation/hooks/useOtherHooks';
...
const Analytics = ({ user }) => {
  ...
  const recentTransactions = transactions.slice(0, 5) || [
    ...
    },
    {
      ...
      created_at: '2024-04-18T11:20:00Z',
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <span className="text-xs text-green-600 flex items-center">
                        <ArrowUpRight className="h-3 w-3 mr-1" />+
                        {calculateGrowth(
                          stats?.current_month_earnings || 0,
                          (stats?.current_month_earnings || 100) * 0.7
                        )}
                        % from last month
                      </span>
                    </div>
                ...
                <div className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-xl font-bold text-gray-900">
                        {formatNumber(
                          (stats?.current_month_earnings || 0) * 0.65
                        )}{' '}
                        UGX
                      </h3>
                      <span className="text-xs text-green-600 flex items-center">
                        ...
                        {calculateGrowth(
                          (stats?.current_month_earnings || 0) * 0.65,
                          (stats?.current_month_earnings || 100) * 0.4
                        )}
                        % from last month
                      </span>
                    </div>
                  ...
                  {recentTransactions.map(transaction => (
                    ...
                    >
                      ...
                      >
                        ...
                        {formatNumber(transaction.amount)} UGX
                      </span>
                    </div>
                  ))}
                </div>
                  ...
                  <div>
                    ...
                    <span className="text-xs text-green-600 flex items-center">
                      ...
                      {calculateGrowth(
                        ...
                        (stats?.messages_received || 100) * 0.85
                      )}
                      % from last month
                    </span>
                  </div>
                    ...
                    <div className="flex items-center mb-2">
                      ...
                      <div className="flex items-center">
                        {[1, 2, 3, 4, 5].map(star => (
                          <svg
                            key={star}
                            className={`w-4 h-4 ${star <= Math.round(stats?.rating || 4.8) ? 'text-amber-500' : 'text-gray-300'}`}
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                ...
                <div className="space-y-2">
                  <div className="p-2 bg-blue-50 rounded-lg border border-blue-100">
                    <p className="text-sm text-blue-800">
                      Responding faster could increase your client satisfaction
                      by up to 15%.
                    </p>
                  </div>
                  <div className="p-2 bg-green-50 rounded-lg border border-green-100">
                    <p className="text-sm text-green-800">
                      Try to maintain detailed answers to financial questions -
                      they get the best ratings!
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-green-600 flex items-center">
                      <ArrowUpRight className="h-3 w-3 mr-1" />+
                      {calculateGrowth(
                        stats?.profile_views || 4582,
                        (stats?.profile_views || 4582) * 0.75
                      )}
                      % from last month
                    </span>
                  </div>
                ...
                <div className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-green-600 flex items-center">
                      <ArrowUpRight className="h-3 w-3 mr-1" />+
                      {calculateGrowth(
                        stats?.premium_subscribers || 124,
                        (stats?.premium_subscribers || 124) * 0.8
                      )}
                      % from last month
                    </span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="p-2 bg-gray-50 rounded-lg flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Premium Article • Published 2 weeks ago
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="p-2 bg-gray-50 rounded-lg flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-800">
                          Market Analysis: Q1 Report
                        </p>
                        <p className="text-xs text-gray-500">
                          Premium Article • Published 1 month ago
                        </p>
                      </div>
                    </div>
                    <div className="text-right">
                  ...
                  <div className="p-2 bg-gray-50 rounded-lg flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Free Article • Published 3 weeks ago
                        </p>
                      </div>
                    </div>
                    <div className="text-right">
                ...
                <div className="bg-white rounded-lg p-3 border border-gray-200 shadow-sm">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-green-600 flex items-center">
                      <ArrowUpRight className="h-3 w-3 mr-1" />+
                      {calculateGrowth(
                        stats?.new_contacts || 156,
                        (stats?.new_contacts || 156) * 0.7
                      )}
                      % from last month
                    </span>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="p-2 bg-green-50 rounded-lg border border-green-100">
                        ...
                        <p className="text-xs text-green-700">
                          Publishing regular financial insights could increase
                          your engagement by 35%.
                        </p>
                      </div>
                      <div className="p-2 bg-blue-50 rounded-lg border border-blue-100">
                        ...
                        <p className="text-xs text-blue-700">
                          Improving your response time could boost your
      ...
      >
          ...
          <div className="flex items-center mb-3">
            ...
            <div>
              <h3 className="font-medium text-gray-800">
                {profileLoading ? '...' : profile?.name || 'John Kamara'}
              </h3>
          ...
          <div className="space-y-2">
            <div className="p-2 bg-amber-50 rounded-lg border border-amber-100">
              ...
              <p className="text-xs text-amber-700">
                Your profile gets most views between 7PM-9PM. Consider posting
            ...
            <div className="p-2 bg-blue-50 rounded-lg border border-blue-100">
              ...
              <p className="text-xs text-blue-700">
                Users who reply to messages within 15 minutes see 40% higher
                conversion rates.
              </p>
            </div>
          </div>
        ...
        <div className="mt-auto p-2 bg-gray-50 rounded-lg">
          ...
          <p className="text-xs text-gray-600 mb-2">
            Contact our support team for any questions about your analytics.
          </p>
