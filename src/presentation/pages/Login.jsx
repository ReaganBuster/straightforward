  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="w-full max-w-md p-4 sm:p-6 space-y-6 bg-white rounded-lg shadow-lg sm:rounded-xl">
        ...
        {error && (
          <div
            className="p-2 sm:p-3 text-xs sm:text-sm text-white bg-red-500 rounded-md"
            role="alert"
          >
            {error}
          </div>
        ...
        >
          ...
          <div className="flex items-center justify-between flex-col sm:flex-row gap-2 sm:gap-0">
            <div className="flex items-center">
              ...
              <label
                htmlFor="remember-me"
                className="block ml-2 text-xs sm:text-sm text-gray-700"
              >
                Remember me
              </label>
            </div>
            ...
            >
              {loading ? (
                <span className="flex items-center">
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 animate-spin"
